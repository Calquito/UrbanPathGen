...
#image
depth_area, depth_estimation_matrix,bounded_matrix=complete_analysis(drones[1],image,transform,device,midas,threshold_fraction,image_percentage,submatrices,vision_field_degrees)
